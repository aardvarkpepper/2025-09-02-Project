...
const { createProject, getAllProjects, getProjectById, updateProjectById, deleteProjectById, createTask, getAllTasksByProject } = require('../../controllers/projectController');
...
router.get('/:projectId/tasks', verifyAuthentication, getAllTasksByProject);
